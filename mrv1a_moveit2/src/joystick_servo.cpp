...
const std::string BASE_FRAME_ID = "mrv1a_base";
                     ...
                     std::unique_ptr<control_msgs::msg::JointJog>& joint)
{
  ...
  if (buttons[A] || buttons[B] || buttons[X] || buttons[Y] || axes[D_PAD_X] || axes[D_PAD_Y])
  {
    ...
    joint->joint_names.push_back("joint_a1");
    joint->velocities.push_back(axes[D_PAD_X]);
    joint->joint_names.push_back("joint_a2");
    joint->velocities.push_back(axes[D_PAD_Y]);

    // Map the diamond to the distal joints
    joint->joint_names.push_back("joint_a7");
    joint->velocities.push_back(buttons[B] - buttons[X]);
    joint->joint_names.push_back("joint_a6");
...
public:
  ...
  void joyCB(const sensor_msgs::msg::Joy::SharedPtr msg)
  {
    ...
    else
    {
      ...
      joint_msg->header.frame_id = "joint_a3";
...
RCLCPP_COMPONENTS_REGISTER_NODE(mrv1a_servo::JoyToServoPub)
